...
public interface SdpDBServiceLocal extends EJBLocalObject {
   ...
   */
  public void createCommsatLog(String subscriptionOfferId, String emailId, String redemptionCode, String templateId, String status, String userId, String confirmationId, String transactionDate, String bbyId, String lineItemId, String regId) ;
  /**
   * * 
 ...
 * @throws ApplicationException
   ...
   * @weblogic.ejbgen.RemoteMethod 
   */
  public void createExceptionMessage(org.apache.xmlbeans.XmlObject requestXmlObject, String sdpId, String sdpOrderId, String srcSysId)  throws com.accenture.common.ex.ApplicationException;
  /**
   * @weblogic.ejbgen.LocalMethod 
   * @weblogic.ejbgen.RemoteMethod 
   */
  public void createMerchantLinkTokenLog(String subscriptionOfferId, String vendorID, String bBYID, String custName, String ccToken, String cardType, String expirationDate, String address1, String address2, String city, String state, String zip, String processedFlag) ;
  /**
   * * 
 ...
 * @throws ApplicationException
   ...
   * @weblogic.ejbgen.RemoteMethod 
   */
  public com.bestbuy.schemas.sdp.db.createOrder.CreateOrderResponseDocument createOrder(org.apache.xmlbeans.XmlObject requestXmlObject)  throws com.accenture.common.ex.ApplicationException;
  /**
   * @weblogic.ejbgen.LocalMethod 
   * @weblogic.ejbgen.RemoteMethod 
   */
  public String getTemplateId(String sku, String dateString) ;
  /**
   * @weblogic.ejbgen.LocalMethod 
   * @weblogic.ejbgen.RemoteMethod 
   */
  public com.bestbuy.schemas.sdp.db.retrieveCatalog.RetrieveCatalogOfferResponseDocument retrieveCatalogByDigitalAttributes(org.apache.xmlbeans.XmlObject requestXmlObject)  throws com.accenture.common.ex.ApplicationException;
  /**
   * * 
 ...
 * @throws ApplicationException
   ...
   * @weblogic.ejbgen.RemoteMethod 
   */
  public com.bestbuy.schemas.sdp.db.retrieveCatalog.RetrieveCatalogOfferResponseDocument retrieveCatalogBySku(org.apache.xmlbeans.XmlObject requestXmlObject)  throws com.accenture.common.ex.ApplicationException;
  /**
   * * 
 ...
 * @throws ApplicationException
   ...
   * @weblogic.ejbgen.RemoteMethod 
   */
  public com.bestbuy.schemas.sdp.db.retrieveOrder.RetrieveOrderResponseDocument retrieveOrder(org.apache.xmlbeans.XmlObject requestXmlObject)  throws com.accenture.common.ex.ApplicationException;
  /**
   * * 
 ...
 * @throws ApplicationException
   ...
   * @weblogic.ejbgen.RemoteMethod 
   */
  public com.bestbuy.schemas.sdp.db.updateOrder.UpdateOrderResponseDocument updateOrder(org.apache.xmlbeans.XmlObject requestXmlObject)  throws com.accenture.common.ex.ApplicationException;
}
